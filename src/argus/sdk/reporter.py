...
class ArgusReporter:
    ...
    def _build_otlp_payload(
        ...
        *,
        ...
        This follows the GenAI Semantic Conventions v1.37 attribute mapping.
        """
    ...
    async def report_span(
        ...
        **kwargs: Any,
        ...
        Additional keyword arguments are passed to _build_otlp_payload
        (trace_id, span_id, parent_span_id, tool_name, tool_type, error_type, conversation_id).
